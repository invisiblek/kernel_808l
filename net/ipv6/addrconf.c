...
/*Add patch 20120216 by lisashih*/
	                                                  ...
	                                                  u32 flags, u32 noflags)
{
	        ...
	        if (!fn)
	                goto out;
	        for (rt = fn->leaf; rt; rt = rt->dst.neighbour) {
...
static void addrconf_dad_completed(struct inet6_ifaddr *ifp)
{
	...
	//if (ifp->idev->cnf.forwarding == 0 &&
	 //add by lisashih 20120206
	if ((ifp->idev->cnf.forwarding == 0 || ifp->idev->cnf.accept_ra >= 2 || ifp->idev->cnf.forwarding == 2) &&
