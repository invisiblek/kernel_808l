...
//Leo add 2012/01/18
static struct proc_dir_entry *proc_sip = NULL;
static int sip_enable = 1;
...
static int __init nf_conntrack_sip_init(void)
{
	...
	//Leo add 2012/01/18
	proc_sip=create_proc_entry("sip",0,NULL);
	if (proc_sip)
	{
	    proc_sip->read_proc=sip_read_proc;
	    proc_sip->write_proc=sip_write_proc;
	}
	//Leo add end
