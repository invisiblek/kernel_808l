...
#ifdef CONFIG_CAMEO_ALG_H323
//Xavier@20130515
static int h323_enable = 1;
static int h323_read_proc(char *page, char **start, off_t off,
...
static int h323_write_proc(struct file *file, const char *buffer,
...
static int __init nf_conntrack_h323_init(void)
{
	int ret;
	#ifdef CONFIG_CAMEO_ALG_H323
	static struct proc_dir_entry *proc_h323 = NULL;
	#endif
	...
	#ifdef CONFIG_CAMEO_ALG_H323
	//Xavier@20130515
	proc_h323 = create_proc_entry("h323",0,NULL);
	if (proc_h323)
	{
	    proc_h323->read_proc	= h323_read_proc;
	    proc_h323->write_proc	= h323_write_proc;
	}
	//End
	#endif
