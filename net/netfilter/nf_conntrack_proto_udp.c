...
static unsigned int nf_ct_udp6_timeout_stream __read_mostly = 60*HZ;
static unsigned int nf_ct_udp6_timeout_stream_out_wkport __read_mostly = 300*HZ;
#endif
/* Dino */
...
static struct ctl_table udp_compat_sysctl_table[] = {
...
#if defined(CONFIG_CAMEO_CT_NEW)
	{
		.procname	= "ip_conntrack_udp6_timeout",
	...
	{
		.procname	= "ip_conntrack_udp6_timeout_stream",
		.data		= &nf_ct_udp6_timeout_stream,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_jiffies,
	},
	{
		.procname	= "ip_conntrack_udp6_timeout_stream_out_wkport",
		.data		= &nf_ct_udp6_timeout_stream_out_wkport,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_jiffies,
	},
