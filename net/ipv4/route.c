...
#ifndef CONFIG_IP_MROUTE_MULTIPLE_TABLES //Bernie added, pass igmpv3 report msg to user space.
extern bool query_mrt_mroute_sk(struct net *net);
#endif
