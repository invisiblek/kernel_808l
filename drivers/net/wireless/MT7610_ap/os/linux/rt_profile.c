...
char const *pWirelessWscEventText[IW_WSC_EVENT_TYPE_NUM] = {   	
	...
	/* cameo brian add */
	"WPS Not only one candidate found",							/* IW_WSC_MANY_CANDIDATE */
	"WPS Next candidate found",									/* IW_WSC_NEXT_CANDIDATE */	
	"WPS T1 timer timeout",									/* IW_WSC_T1_TIMER_TIMEOUT */	
	"WPS T2 timer timeout",									/* IW_WSC_T2_TIMER_TIMEOUT */	
	"WPS Receive identity",									/* IW_WSC_RECEIVE_IDENTITY */		
	"PinCounter Lock"										/* IW_WSC_SET_PINLOCKE */
	};
#endif /* WSC_INCLUDED */
