	...
	*/
		...
		WMODE_CAP_N(pAd->CommonCfg.PhyMode))
	{
		...
		if (WMODE_CAP_AC(pAd->CommonCfg.PhyMode) &&
			...
			ie_list->vht_cap_len)
		{
			VHT_CAP_INFO *vht_cap_info = &ie_list->vht_cap;
...
//==================================================    	 	
	 	                ...
	 	                if ((NULL != pEntry) && (0 != pAd->MacTab.Size))	 	 	 	 
	 	                {	 	 	 	 
	 	                        MulticastFilterTableInsertSpecialEntrys(pAd, pEntry->Addr, get_netdev_from_bssid(pAd, pEntry->apidx));	 	 	 	 
	 	                }	 	 	 	 
