...
//=======================	 	 	
static unsigned char itunes_mac[ETH_LENGTH_OF_ADDRESS] = {0x01, 0x00, 0x5e, 0x00, 0x00, 0xfb};	 	 	 	 	 	 
...
static inline BOOLEAN isSpecialIgmpMacAddr(	 	 	 	 
	IN PUCHAR pGrpId);	 	 	 	 
//==================================================	 	 	 	 
	...
	IN PNET_DEV pDev)
{
	...
	if(isIgmpPkt(pDstMacAddr, pIpHeader))
	{
		...
		case IGMP_V2_MEMBERSHIP_REPORT: /* IGMP version 2 membership report. */
			...
			//==================================================
			if (!isSpecialIgmpMacAddr(GroupMacAddr)){
...
#define	IS_MDNSADDR(a)		((((long int) htonl(a)) & 0xffffff00) == (0xe0000000))
...
#define IS_IPV6_RA_MAC_ADDR(Addr)	(  Addr[0]  == 0x33  &&  Addr[1]  == 0x33&&  Addr[2]  == 0x00&&  Addr[3]  == 0x00 &&  Addr[4]  == 0x00&& Addr[5]  == 0x01)
#define IS_IPV6_RS_MAC_ADDR(Addr)	(  Addr[0]  == 0x33  &&  Addr[1]  == 0x33&&  Addr[2]  == 0x00&&  Addr[3]  == 0x00 &&  Addr[4]  == 0x00&& Addr[5]  == 0x02)
#define IS_IPV6_NS_MAC_ADDR(Addr)	(  Addr[0]  == 0x33  &&  Addr[1]  == 0x33&&  Addr[2]  == 0xFF)
...
//==================================================    	 	 	 	 
void MulticastFilterTableInsertSpecialEntrys(	 	 	 	 
	        IN PRTMP_ADAPTER pAd,	 	 	 	 
	        IN PUCHAR pMemberAddr,	 	 	 	 
	        IN PNET_DEV dev)	 	 	 	 
{	 	 	 	 	 
	MulticastFilterTableInsertEntry(pAd, itunes_mac, pMemberAddr, dev, MCAT_FILTER_STATIC);	 	  
}	 	 	 	 
