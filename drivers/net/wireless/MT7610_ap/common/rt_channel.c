...
/* Latin America */
CH_DESP Country_LA_ChDesp[]=
{
	{ 1,   11, 18, BOTH, FALSE},	/*2402~2472MHz, Ch 1~11,   Max BW: 40 */
	{ 149,  4, 24, BOTH, FALSE},	/*5735~5835MHz, Ch 149~161, Max BW: 40 */		
	{ 0},               	    	/* end*/
};
/* Latin America */
CH_DESP Country_DI_ChDesp[]=
{
	{ 1,   11, 18, BOTH, FALSE},	/*2402~2472MHz, Ch 1~11,   Max BW: 40 */
	{ 149,  4, 17, BOTH, FALSE},	/*5735~5835MHz, Ch 149~161, Max BW: 40 */		
	{ 0},               	    	/* end*/
};
/*Albania*/
...
CH_DESP Country_AU_ChDesp[] =
{
	...
	{ 36,   4, 20, BOTH, FALSE},	/*5170~5250MHz, Ch 36~48, Max BW: 40 */
	{ 52,   4, 20, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */
	{ 100,  5, 24, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40*/
	{ 132,  3, 24, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40*/
...
{
	{ 1,   11, 18, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 15, BOTH, FALSE},	/*5170~5250MHz, Ch 36~48, Max BW: 40 */
	//{ 52,   4, 19, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */
	//{ 100, 11, 19, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 149,  5, 24, BOTH, FALSE},	/*5735~5835MHz, Ch 149~165, Max BW: 40 */
	{ 0},               	    	/* end*/
};
/*Brunei Darussalam*/	
...
CH_DESP Country_CA_ChDesp[] =
{
	...
	{ 52,   4, 15, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */
	//{ 100, 11, 20, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40 */
	{ 100,  5, 19, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40*/
	{ 132,  3, 19, BOTH, TRUE}, 	/*5490~5710MHz, Ch 100~140, Max BW: 40*/ 
	{ 149,  5, 24, BOTH, FALSE},	/*5735~5835MHz, Ch 149~165, Max BW: 40 */
	{ 0},               	    	/* end*/
};
/*Chile*/	
...
{
	{ 1,   13, 17, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 40 */
	{ 149,  5, 24, BOTH, FALSE},	/*5735~5835MHz, Ch 149~165, Max BW: 40 */	
	{ 0},               	    	/* end*/
};
/*Colombia*/		
...
{
	{ 1,   13, 17, BOTH, FALSE},	/*2400~2483.5MHz, Ch 1~13,   Max BW: 40 */
	{ 36,   4, 20, IDOR, FALSE},	/*5150~5250MHz, Ch 36~48, Max BW: 40 */
	{ 52,   4, 20, IDOR, TRUE}, 	/*5250~5350MHz, Ch 52~64, Max BW: 40 */
	{ 100, 11, 24, BOTH, TRUE}, 	/*5470~5725MHz, Ch 100~140, Max BW: 40 */
	{ 0},               	    	/* end*/
};
/*Greece*/		
...
{
	{ 1,    13, 17, BOTH, FALSE},	/*2402~2472MHz, Ch 1~11,   Max BW: 20 */
...
{
	{ 1,   13, 17, BOTH, FALSE},	/*2402~2482MHz, Ch 1~13,   Max BW: 20 */
	{ 36,   4, 20, BOTH, FALSE},	/*5170~5250MHz, Ch 36~48, Max BW: 20 */
	{ 52,   4, 20, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 20 */
	{ 100,  7, 24, BOTH, TRUE}, 	/*5490~5630MHz, Ch 100~124, Max BW: 40 */
	{ 149,  4, 30, BOTH, FALSE},	/*5735~5815MHz, Ch 149~161, Max BW: 40 */
	{ 0},               	    	/* end*/
};
/*Kuwait*/		
...
{
	{ 1,   11, 18, BOTH, FALSE},	/*2402~2472MHz, Ch 1~11,   Max BW: 40 */
	{ 56,   3, 14, IDOR, TRUE}, 	/*5270~5330MHz, Ch 56~64, Max BW: 40 */
	//{ 100,  11, 19, BOTH, TRUE}, 	/*5270~5330MHz, Ch 56~64, Max BW: 40 */
	{ 149,  5, 23, BOTH, FALSE},	/*5735~5815MHz, Ch 149~161, Max BW: 40 */			
	{ 0},               	    	/* end*/
};
/*Thailand*/		
...
CH_DESP Country_US_ChDesp[] =
{
	...
	{ 36,   4, 20, IDOR, FALSE},	/*5170~5250MHz, Ch 36~48, Max BW: 40 */
	{ 52,   4, 19, BOTH, TRUE}, 	/*5250~5330MHz, Ch 52~64, Max BW: 40 */
	{ 100,  8, 19, BOTH, TRUE}, 	/*5490~5600MHz, Ch 100~116, Max BW: 40 */
	{ 132,  3, 19, BOTH, TRUE}, 	/*5650~5710MHz, Ch 132~140, Max BW: 40 */
	{ 149,  5, 24, BOTH, FALSE},	/*5735~5835MHz, Ch 149~165, Max BW: 40 */
	{ 0},               	    	/* end*/
};
/*Uruguay*/		
...
CH_REGION ChRegion[] =
{
	...
	{"LA", FCC, Country_LA_ChDesp}, /* Latin Anerica */
	{"DI", FCC, Country_DI_ChDesp}, /* Latin Anerica */
	{""  , 0,  NULL}	     , /* End */	
};
