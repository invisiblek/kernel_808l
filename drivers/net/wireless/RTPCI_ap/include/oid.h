...
#else
#define MAX_NUMBER_OF_MAC				128	/* if MAX_MBSSID_NUM is 8, this value can't be larger than 211 Cameo brian modify for support 128 client*/
#endif
