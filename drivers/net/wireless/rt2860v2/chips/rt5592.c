...
const REG_PAIR BBP5592Reg_2G_5G[] = 
{
	...
	{BBP_R74, 0x0F},
	//{BBP_R75, 0x4F},
	{BBP_R75, 0x52}, //mtk patch for tp issue
	{BBP_R76, 0x28},
	{BBP_R77, 0x59},
	{BBP_R84, 0x96}, //mtk patch for tp issue
	//{BBP_R84, 0x9A},
	{BBP_R86, 0x38},
	{BBP_R88, 0x90},
	{BBP_R91, 0x04},
...
static const RTMP_REG_PAIR	MAC5592Reg[] =	{
	{TX_SW_CFG0,		0x0404},
	{MAX_LEN_CFG,		0x3FFF}, // mtk patch for tp issue
//	{MAX_LEN_CFG,		0x2FFF},
...
//	RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R84, 0x9a);
	RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R84, 0x96);
	...
	IN PRTMP_ADAPTER		pAd)
{
	...
	DBGPRINT(RT_DEBUG_OFF, ("This is RT5592 !\n"));
